...
<head>
    ...
    <title style="background-color:black;color:white;">ANNEXURE-I</title>
...
$all_annexure1s = $data['all_annexure1s'];
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0">Number of Work Completed</h4>
                ...
                <div class="container-fluid general-widget">
                    ...
                    <th class="sort text-uppercase" data-sort="updated_at">Last Finalized</th> --}}
                                            ...
                                            <tbody>
                                                <?php $count = 0; ?>
                                                <?php foreach($all_annexure1s as $all_annexure1){
                        $count++; ?>


                                                <tr>
                                                    <td><?php echo $count; ?></td>
                                                    <td><?php echo $all_annexure1->start_date; ?></td>
                                                    <td><?php echo $all_annexure1->end_date; ?></td>
                                                    <td><?php echo $all_annexure1->circle; ?></td>
                                                    <td><?php echo $all_annexure1->division; ?></td>
                                                    <td><?php echo $all_annexure1->sd_pincode; ?></td>
                                                    <td><?php echo $all_annexure1->so_pincode; ?></td>
                                                    <td><?php echo $all_annexure1->target_to_achieve; ?></td>
                                                    {{-- <td><?php echo $all_annexure1->actual_completed; ?></td> --}}
                                                    <td><?php echo $all_annexure1->created_at; ?></td>
...
<div class="modal fade" id="showModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="create_annexure1" method="POST">
                @csrf
                <div class="modal-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-lg-12">
                            <div>
                                <label for="company_name-field" class="form-label">Start Date <span
                                        class="mandatory_star">*<sup><i>required</i></sup></span></label>
                                <input type="date" id="company_name-field" class="form-control" name="start_date"
                                    placeholder="Enter " required />
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div>
                                <label for="company_name-field" class="form-label">End Date <span
                                        class="mandatory_star">*<sup><i>required</i></sup></span></label>
                                <input type="date" id="company_name-field" class="form-control" name="end_date"
                                    placeholder="Enter" required />
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div>
                                <label for="company_name-field" class="form-label">Circle <span
                                        class="mandatory_star">*<sup><i>required</i></sup></span></label>
                                <input type="number" id="company_name-field" class="form-control" name="circle"
                                    placeholder="Enter Circle" required />
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div>
                                <label for="company_name-field" class="form-label">Division <span
                                        class="mandatory_star">*<sup><i>required</i></sup></span></label>
                                {{-- <input type="number" id="company_name-field" class="form-control" name="division"
                        ...
                        <div class="col-lg-12">
                            <div>
                                ...
                                <select class="form-control" name="sd_pincode" id="sub_division" required>
                                    <option value="" disabled="disabled" selected="selected">Please Select
                                    </option>
                        ...
                        <div class="col-lg-12">
                            <div>
                                <label class="form-label" for="product-title-input">SO Code <span
                                        class="mandatory_star">*<sup><i>required</i></sup></span></label>
                                ...
                                <select class="form-control" name="so_pincode" id="section" required>
                                    <option value="" disabled="disabled" selected="selected">Please Select
                                    </option>
                        ...
                        <div class="col-lg-12">
                            <div>
                                <label for="company_name-field" class="form-label"> Target to be achieved <span
                                        class="mandatory_star">*<sup><i>required</i></sup></span></label>
                                <input type="text" id="company_name-field" class="form-control"
                                    name="target_to_achieve" placeholder="Enter Target to be achieved" required />
                            </div>
                        </div>
                        {{-- <div class="col-lg-12">
                            <div>
                                <label for="company_name-field" class="form-label">	Actual completed status <span class="mandatory_star">*<sup><i>required</i></sup></span></label>
                                <input type="text" id="company_name-field" class="form-control" name="actual_completed" placeholder="Enter" required />
                            </div>
                        </div> --}}
