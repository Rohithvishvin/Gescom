                                ...
                                <div class="live-preview">
                                    <div class="table-responsive">
                                        <table style="width:100%"
                                            ...
                                            <tr>
                                                <th style="color: red">Previous Final Reading</th>
                                                <td style="color: red; font-weight: bold">{{ $meter_previous_final_reading->reading??0 }}</td>

                                                <td>---NA---</td>
                                            </tr>

                                            <tr>
                                                <th style="color: red">Difference fom FR Reading</th>
                                                <td style="color: red; font-weight: bold">{{ ($meter_main->final_reading- $meter_previous_final_reading->reading??0) }}</td>
                                            ...
                                            $contractor = Admin::where('id',$admin->created_by)->first();
                                            @endphp
                                            <tfoot>
                                                <tr>
                                                    <th ><h6>Field Executive Name: {{$admin->name}}</h6></th>
                                                    <td ><h6>Phone: {{$admin->phone}}</h6></td>

                                                </tr>
                                                <tr>
                                                    <th ><h6>Contractor Name: {{$contractor->name}}</h6></th>
                                                    <td ><h6>Phone: {{$contractor->phone}}</h6></td>
                                                </tr>
                                            </tfoot>
                                        </table>
                                        @if ($meter_main->qc_status == 0)
                                            ...
                                            <form id="createproduct-form" autocomplete="off" class="needs-validation"
                                                ...
                                                Reject</button> --}}
                                                                ...
                                                                <!-- Reject Button -->
                                            <button type="button" class="btn btn-danger add-btn" data-bs-toggle="modal" data-bs-target="#showModal_reject">
                                                <i class="ri-delete-bin-2-line"></i> Reject
                                            </button>

                                            <!-- Preview Button -->
                                            <button type="button" class="btn btn-primary add-btn" data-bs-toggle="modal" data-bs-target="#showModal_preview">
                                        ...
                                        <!-- Reject Modal -->
                                        <div class="modal fade zoomIn" id="showModal_reject" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered modal-lg">
                                                <div class="modal-content border-0">
                                                    <div class="modal-header p-3 bg-soft-info">
                                                        <h5 class="modal-title" id="exampleModalLabel">Reject QC Report</h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                                    <form action="/qcs/reject_qc_reports_status/{{ $meter_main->id }}" method="post" autocomplete="off" enctype="multipart/form-data">
                                                        @csrf
                                                        <div class="modal-body">
                                                            <div class="row g-3">
                                                                <div class="col-lg-12">
                                                                    <label for="qcRemarkReject" class="form-label">Enter Remark</label>
                                                                    <input type="text" id="qcRemarkReject" class="form-control" name="qc_remark" placeholder="Enter remark before rejecting" required />
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <!-- Preview Modal -->
                                        <div class="modal fade zoomIn" id="showModal_preview" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered modal-lg">
                                                <div class="modal-content border-0">
                                                    <div class="modal-header p-3 bg-soft-info">
                                                        <h5 class="modal-title" id="exampleModalLabel">Preview QC Report</h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                                    <form action="/qcs/preview_qc_reports_status/{{ $meter_main->id }}" method="post" autocomplete="off" enctype="multipart/form-data">
                                                        @csrf
                                                        <div class="modal-body">
                                                            <div class="row g-3">
                                                                <div class="col-lg-12">
                                                                    <label for="qcRemarkPreview" class="form-label">Enter Remark</label>
                                                                    <input type="text" id="qcRemarkPreview" class="form-control" name="qc_remark" placeholder="Enter remark for preview" required />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="modal-footer">
