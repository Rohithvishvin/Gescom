        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <div class="text-end mb-3">
                    <button type="submit" id="approve-button" class="btn btn-success w-sm">Approve</button>
                </div>
                </form>
            </div>
...
<script>
    ...
    // // Enable the "Approve" button when the page has finished loading
    // $(window).on('load', function() {
    //     $('#approve-button').prop('disabled', false);
    // });

    $(document).ready(function() {
    // Check if the page is fully loaded (including images and other assets)
    $(window).on('load', function() {
        $('#approve-button').prop('disabled', false);
    });
});
