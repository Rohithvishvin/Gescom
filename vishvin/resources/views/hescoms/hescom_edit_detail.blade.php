    ...
    <div class="page-content">
        <div class="container-fluid">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item">
                                    <a href="javascript: void(0);">Hescom</a>
                                </li>
                                <li class="breadcrumb-item active">Edit Meter Main Report</li>
                            </ol>
                        </div>
            ...
            <form id="createproduct-form" autocomplete="off" class="needs-validation"
                  action="/hescoms/hescom_update_detail/{{ $meter_main->id }}" method="POST"
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3 mt-0">
                                    <label for="ticket-status" class="form-label">Photo 1 (with
                                        reading) @if (!empty($meter_main->image_1_old))
                                    ...
                                    <input type="hidden" id="assignedtoName-field" class="form-control"
                                           placeholder="Section" value="{{ $meter_main->image_1_old }}"
                                           name="image_1_old" readonly/>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="hidden" id="assignedtoName-field" class="form-control"
                                           ...
                                           name="image_2_old" readonly/>
                                </div>
                                <div class="mb-3">
                                    <label for="ticket-status" class="form-label">Photo 3 (with
                                        reading) @if (!empty($meter_main->image_3_old))
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="assignedtoName-field" class="form-control"
                                           ...
                                           name="final_reading" required/>
                                </div>
                                @if($data['show_so_remark_field'] == "true")
                                <div class="mb-3">
                                    <label for="so-remark-field" class="form-label">SO Remark</label>
                                    <input type="text" id="so-remark-field" class="form-control" name="so_remark" value="{{ trim($meter_main->so_remark) }}" required>
                                </div>
                                @endif
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3 mt-0">
                                    <label for="ticket-status" class="form-label">Photo 1 (with
                                        reading) @if (!empty($meter_main->image_1_new))
                                    ...
                                    <input type="hidden" id="assignedtoName-field" class="form-control"
                                           ...
                                           name="image_1_new" readonly/>
                                </div>


                                <div class="mb-3">
                                    <label for="ticket-status" class="form-label">Photo 2 (with
                                        reading) @if (!empty($meter_main->image_2_new))
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" name="serial_no_new" required
                                            id="serial_no_new_dropdown" disabled readonly>
                                        <?php
                                        ...
                                        ?>
                                        <option value="<?php echo $meter_main->serial_no_new; ?>"
                                                selected><?php echo $meter_main->serial_no_new; ?></option>
                                        <?php ?>
                                    </select>
                                </div>
            ...
            <a href="/hescoms/hescom_view_detail/{{ $meter_main->id }}">
                <button
                    class="btn btn-primary w-sm">Cancel
                </button>
            </a>
        </div>
        <!-- container-fluid -->
