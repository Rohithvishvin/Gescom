                            ...
                            <div class="card-body">
                                ...
                                <div class="live-preview">
                                    <div class="table-responsive">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if (!empty($meter_main->image_3_old))
                                                        <a href="javascript:void(0);"
                                                           onclick="window.open('{{ asset($meter_main->image_3_old) }}', '_blank', 'width=800,height=600');">
                                                            <img src="{{ asset($meter_main->image_3_old) }}"
                                                                 alt="photo1" style="height: 47px; max-width: 100%;">
                                                        </a>
                                                    @else
                                                        {{-- <i class="fa fa-eye-slash"></i> --}}
                                        ...
                                        @endif
                                        @if (Session('rexkod_vishvin_auth_user_type') == 'ae')
                                            @if ($meter_main->so_status == 0 && $data['edit_button_show'] == "true")
                                                <a class="btn btn-primary w-sm" role="button"
                                                   href="/hescoms/hescom_edit_detail/{{ $meter_main->id }}">
                                                    <i class="ri-add-line align-bottom me-1"></i>
                                                    Edit
                                                </a>
                                            @endif
                                            @if ($meter_main->so_status == 0)
                                                <form id="createproduct-form" autocomplete="off"
                                                      class="needs-validation"
                                                      action="{{ url('/') }}/hescoms/approve_so_reports_status/{{ $meter_main->id }}"
                                                    ...
                                                    <div class="hstack gap-2 justify-content-end d-print-none mt-4">
                                                        ...
                                                        <button type="button" class="btn btn-danger add-btn"
                                                                ...
                                                                data-bs-target="#showModal_reject_so"><i
                                        ...
                                        @if (Session('rexkod_vishvin_auth_user_type') == 'aee')
                                            @if ($meter_main->aee_status == 0)
                                                <form id="createproduct-form" autocomplete="off"
                                                      class="needs-validation"
                                                      action="{{ url('/') }}/hescoms/approve_aee_reports_status/{{ $meter_main->id }}"
                                                      method="POST" enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="row">
                                        ...
                                        @if (Session('rexkod_vishvin_auth_user_type') == 'aao')
                                            @if ($meter_main->aao_status == 0)
                                                <form id="createproduct-form" autocomplete="off"
                                                      class="needs-validation"
                                                      action="{{ url('/') }}/hescoms/approve_aao_reports_status/{{ $meter_main->id }}"
                                                      method="POST" enctype="multipart/form-data">
                                                    @csrf
                                                    <div class="row">
...
<div class="modal fade zoomIn" id="showModal_reject_so" tabindex="-1" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
                                            ...
                                            <div class="col-lg-12">
                                                <div id="modal-id">
                                                    ...
                                                    <input type="text" id="orderId" class="form-control"
                                                           placeholder="Enter Remark before rejecting" value=""
