...
<div class="main-content">
            ...
            <div class="row">
                <div class="radio-toolbar col-12">
                    ...
                    @foreach ( $data['sub_division'] as $section)
                        ...
                        <div class="col-lg-3">
                            <input type="radio" id="subDivisionCode" name="subDivisionCode"
    ...
    <script>
        $(document).ready(function () {
            ...
            $(document).on('change', 'input[name = "radioSection"]', divisionCode);
            $(document).on('click', 'input[name = "radioSection"]', divisionCode);
