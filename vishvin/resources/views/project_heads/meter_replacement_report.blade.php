...
<head>
    ...
    <title>Meter Replacement Report (Division:{{$data['division'] ? $data['division']: ''}}
                        ...
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">Meter Replacement Report</li>
                                </ol>
                            </div>
                    ...
                    <div class="col-xl-12 col-md-12 dash-xl-100 dash-lg-100 dash-39">
                        <div class="card ongoing-project recent-orders">
                            <div class="card-header border-0 align-items-center d-flex">
                                <h4 class="card-title mb-0 flex-grow-1">Meter Replacement Report</h4>
                            </div>
                            <div class="card-body pt-0">
                                ...
                                <div class="table-responsive">
                                    <table id="meterReplacementTable" class="table">
                                        <thead>
                                        <tr>
                                            <th>Sl. no.</th>
                                            <th>Account Id</th>
...
<script>
    ...
    var download_base_url = url_parts[0] + '//' + url_parts[2] + "/api/project_heads/download_meter_replacement_report?";
    ...
    function getUrlFilter(filter_data, type = '') {
        var url = "/api/project_heads/meter_replacement_report_data?";
    ...
    function downloadReport() {
        getDataByFilters(filters_data, 'excel');
    }

    table = $('#meterReplacementTable').DataTable({
        fixedHeader: {
            header: true,
            footer: true
        },
