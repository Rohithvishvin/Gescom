                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        @endphp
                                        @foreach ($data['inward_meter'] as $inward_meter)
                                        @php
                                        $count++;
                                        $formattedDate = Carbon::createFromFormat('Y-m-d H:i:s', $inward_meter->created_at)->format('d-m-Y');
                                        @endphp
                                        <tr>
                                            <td>{{$count}}</td>
                                            <td>{{$formattedDate}}</td>
                                            <td>{{$inward_meter->id}}</td>
                                            <td>{{$inward_meter->box_count}}</td>
                                            <td>{{$inward_meter->comma_count}}</td>
