...
<style>
    .mandatory_star{
        ...
        <title>BMR Error Status report (From:{{$data['dateFrom'] ? $data['dateFrom']: ''}},Till:{{$data['dateTo'] ? $data['dateTo']: ''}})</title>
                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active"><a href="{{url('/')}}/project_heads/report_filter">BMR Status Report</a></li>
                                <li class="breadcrumb-item active">BMR Error Status Report</li>
                            </ol>
                        </div>
                ...
                <div class="col-xl-12 col-md-12 dash-xl-100 dash-lg-100 dash-39">
                    <div class="card ongoing-project recent-orders">
                        <div class="card-header border-0 align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">BMR Error Status Report</h4>
                        </div>
                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>error_reported_at</th>
                                            <th>reason</th>
                                            <th>error_updated_by_aao</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        $formattedErrorDate = Carbon::createFromFormat('Y-m-d H:i:s', $meter_main->error_report_created_at)->format('d-m-Y');
                                        @endphp
                                        <tr>
                                            <td>{{++$key}}</td>
                                            ...
                                            <td>{{$formattedDate}}</td>
                                            <td>{{$formattedErrorDate}}</td>
                                            <td>{{$meter_main->error_reason}}</td>
                                            <td>{{$meter_main->error_updated_by_aao}}</td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
