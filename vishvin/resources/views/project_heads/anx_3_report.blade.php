...
<style>
    .mandatory_star{
        ...
        <title>ANX-3 report (Division:{{$data['division'] ? $data['division']: ''}},Sub-division:{{$data['subdivision'] ? $data['subdivision']: ''}},Section:{{$data['section'] ? $data['section']: ''}})</title>
                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">ANX-3 Report</li>
                            </ol>
                        </div>
                ...
                <div class="col-xl-12 col-md-12 dash-xl-100 dash-lg-100 dash-39">
                    <div class="card ongoing-project recent-orders">
                        <div class="card-header border-0 align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">ANX-3 Report</h4>
                        </div>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            @php
                                            $pending_for_replacement = $annexure_1->target_to_achieve - $annexure_1->replaced_count;
                                            @endphp
                                            <td>{{$pending_for_replacement}}</td>
                                            <td>{{$annexure_1->pending_for_verification}}</td>
                                            <td>{{$annexure_1->pending_for_approval}}</td>
                                            <td>{{$annexure_1->pending_for_bmr_upload}}</td>
