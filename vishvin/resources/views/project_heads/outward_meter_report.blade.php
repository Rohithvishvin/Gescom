                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        @php
                                        $count++;
                                        // $formattedDate = Carbon::createFromFormat('Y-m-d H:i:s', $outward_meter->created_at)->format('d-m-Y');
                                        @endphp
                                        <tr>
                                            <td>{{$count}}</td>
                                            <td>{{$outward_meter->date}}</td>
                                            <td>{{$outward_meter->name}}</td>
                                            <td>{{$outward_meter->division}}</td>
                                            <td>{{$outward_meter->lot_no}}</td>
                                            <td>{{$outward_meter->box_id_count}}</td>
