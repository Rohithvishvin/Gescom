...
<head>
    ...
    <title>Contractor wise Stock Report</title>
...
<div id="layout-wrapper">
    ...
    <div class="main-content">
        ...
        <div class="page-content">
            <div class="container-fluid">
                        ...
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">Contractor wise Stock Report</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                {{--                            <h4 class="card-title mb-0 flex-grow-1">Contractor wise Stock Report</h4>--}}
                {{--                        </div>--}}
                ...
                {{--                                            <th>No of Meters Installed</th>--}}
                {{--                                            <th>Pending Meters with contractor</th>--}}
                {{--                                        </tr>--}}
                {{--                                    </thead>--}}
                {{--                                    <tbody>--}}
                {{--                                        @php--}}
                ...
                {{--                                        @endphp--}}
                {{--                                        @foreach ($data['outward_meter'] as $outward_meter)--}}
                {{--                                        @php--}}
                {{--                                        $count++;--}}
                {{--                                        // $formattedDate = Carbon::createFromFormat('Y-m-d H:i:s', $outward_meter->date)->format('d-m-Y');--}}
                {{--                                        @endphp--}}
                {{--                                        <tr>--}}
                {{--                                            <td>{{$count}}</td>--}}
                {{--                                            <td>{{$outward_meter->name}}</td>--}}
                {{--                                            <td>{{$outward_meter->date}}</td>--}}
                {{--                                            <td>{{$outward_meter->meter_count}}</td>--}}
                {{--                                            <td>{{$outward_meter->used_meter_count}}</td>--}}
                {{--                                            <td>{{$outward_meter->unused_meter_count}}</td>--}}
                ...
                {{--                                        <div class="page-title-right">--}}
                {{--                                            <ol class="breadcrumb m-0">--}}
                {{--                                                <li class="breadcrumb-item"><a href="javascript: void(0);">Box Stock</a>--}}
                {{--                                                </li>--}}
                                ...
                                <div class="table-responsive">
                                    <table id="boxStockTable" class="table" style="table-layout: fixed;">
                                        ...
                                        <tr>
                                            ...
                                            <th scope="col">Unused</th>
                                            <th scope="col">Total Unused Meters</th>
                                            <th scope="col">Used</th>
                                            <th scope="col">Total Used Meters</th>
                                            <th scope="col">Balance Meters</th>
                                            <th scope="col">Contractor</th>
                                            <th scope="col">Created At</th>
                                        </tr>
                                        </thead>
                                        {{--                                        <tbody>--}}
                                        {{--                                        @if (isset($data['contractor_inventories']))--}}
                                        {{--                                                <?php $index = 0; ?>--}}
                                        ...
                                        {{--                                                    <td>{{ $contractor_inventory->division }}</td>--}}
                                        {{--                                                    <td>{{ $contractor_inventory->lot_no }}</td>--}}
                                        {{--                                                    <td>{{ str_replace(',', '| ', $contractor_inventory->serial_no) }}</td>--}}
                                        {{--                                                    <td>{{ $contractor_inventory->total_meters }}</td>--}}
                                        {{--                                                    <td>{{ str_replace(',', '| ', $contractor_inventory->unused_meter_serial_no) }}</td>--}}
                                        {{--                                                    <td>{{ $contractor_inventory->total_unused_meters }}</td>--}}
                                        {{--                                                    <td>{{ str_replace(',', '| ', $contractor_inventory->used_meter_serial_no) }}</td>--}}
                                        {{--                                                    <td>{{ $contractor_inventory->total_used_meters }}</td>--}}
                                        {{--                                                    <td>{{ $contractor_inventory->balance_meters }}</td>--}}
                                        {{--                                                    <td>{{ ucwords($contractor_inventory->name) }}</td>--}}
                                        {{--                                                    <td>{{ $contractor_inventory->created_at }}</td>--}}
                                        {{--                                                </tr>--}}
                                        {{--                                            @endforeach--}}
                                        {{--                                        @endif--}}
    ...
    <script>
        ...
        function prepareUrl(filter_data) {
            var url = "/api/get-contractor-wise-stock-report?";
        ...
        var filters_data = <?= $filter ?>;
        console.log(filters_data);
        var json_data = null;
        var table = null;
        table = $('#boxStockTable').DataTable({
            fixedHeader: {
                header: true,
                footer: true
            },
            ...
            "columns": [
                ...
                {
                    data: 'unused_meter_serial_no',
                    "type": "numeric",
                },
                {
                    data: 'total_unused_meters',
                    "type": "numeric",
                },
                {
                    data: 'used_meter_serial_no',
                    "type": "numeric",
                },
                {
                    data: 'total_used_meters',
                    "type": "numeric",
                },
                {
                    data: 'balance_meters',
            ...
            "initComplete": function (settings, json) {
                ...
                var last_row_temp =
                    ...
                    "<td></td>" +
                    "<td>Total Meters</td>" +
                    "<td>" + json.total_meters + "</td>" +
                    "<td>Total Unused Meters</td>" +
                    "<td>" + json.total_unused_meters + "</td>" +
                    "<td>Total Used Meters</td>" +
                    "<td>" + json.total_used_meters + "</td>" +
                    "<td>" + json.total_balance_meters + "</td>" +
                    "<td></td>" +
                    "<td></td>" +
                    "</tr>";
                $('#boxStockTable > tbody').append(last_row_temp);
            },
        });
        //});
