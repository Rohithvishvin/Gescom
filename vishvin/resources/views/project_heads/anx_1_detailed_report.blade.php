...
<style>
    .mandatory_star{
        ...
        <title>Anx-1 Detailed Report (Division:{{$data['division'] ? $data['division']: ''}},Sub-division:{{$data['subdivision'] ? $data['subdivision']: ''}},Section:{{$data['section'] ? $data['section']: ''}})</title>
                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Anx-1 Detailed Report</li>
                            </ol>
                        </div>
                ...
                <div class="col-xl-12 col-md-12 dash-xl-100 dash-lg-100 dash-39">
                    <div class="card ongoing-project recent-orders">
                        <div class="card-header border-0 align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">Anx-1 Detailed Report</h4>
                        </div>
                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>New Meter IR</th>
                                            <th>Replaced Date</th>
                                            <th>Verified by (SO)</th>
                                            <th>Verified by (AEE)</th>
                                            <th>BMR uploaded by (AAO)</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{$count}}</td>
                                            <td>{{$meter_main->division}},{{$meter_main->div_code}}</td>
                                            <td>{{$meter_main->sub_division}},{{$meter_main->sd_code}}</td>
                                            <td>{{$meter_main->section_office}},{{$meter_main->so_code}}</td>
                                            ...
                                            <td>{{"Rejected"}}</td>
                                            @elseif($meter_main->aee_status == 0)
                                            <td>{{"Pending"}}</td>
                                            @endif
                                            ...
                                            <td>{{"Rejected"}}</td>
                                            @elseif($meter_main->aao_status == 0)
                                            <td>{{"Pending"}}</td>
                                            @endif
                                        </tr>
                                        @php
