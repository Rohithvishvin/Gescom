...
<head>
    ...
    <title> BMR Success Status report (From:{{$data['start_date'] ? $data['start_date']: ''}}
        ,Till:{{$data['end_date'] ? $data['end_date']: ''}})</title>
...
<div id="layout-wrapper">
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active"><a
                                                href="{{url('/')}}/project_heads/report_filter">BMR Status Report</a>
                                    </li>
                                    <li class="breadcrumb-item active">BMR Success Status Report</li>
                                </ol>
                            </div>
                    ...
                    <div class="col-xl-12 col-md-12 dash-xl-100 dash-lg-100 dash-39">
                        <div class="card ongoing-project recent-orders">
                            <div class="card-header border-0 align-items-center d-flex">
                                <h4 class="card-title mb-0 flex-grow-1">BMR Success Status Report</h4>
                            </div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="col-2">
                                        <label class="form-label" for="filter_meter_new_serial_no">New Meter Serial No</label>
                                ...
                                <div class="table-responsive">
                                    <table id="bmrSuccessTable" class="table" style="table-layout: fixed;">
                                        <thead>
                                        <tr>
                                            <th>Sl. no.</th>
                                            <th>Account Id</th>
                                            ...
                                            <th>ES Make</th>
                                            <th>Date of Replacment</th>
                                            <th>success_reported_at</th>
                                        </tr>
                                        </thead>
                                        {{--                                        <tbody>--}}
                                        {{--                                        @foreach ($data['results'] as $key=>$meter_main)--}}
                                        {{--                                            @php--}}
                                        ...
                                        {{--                                                $formattedSuccessDate = Carbon::createFromFormat('Y-m-d H:i:s', $meter_main->successful_records_report_created_at)->format('d-m-Y');--}}
                                        {{--                                            @endphp--}}
                                        {{--                                            <tr>--}}
                                        {{--                                                <td>{{++$key}}</td>--}}
    ...
    <script>
        ...
        var download_base_url = url_parts[0] + '//' + url_parts[2] + "/api/project_heads/download_bmr_status_success_report?";
        ...
        function getUrlFilter(filter_data, type = ''){
            var url = "/api/project_heads/bmr_status_success_report_data?";
        ...
        table = $('#bmrSuccessTable').DataTable({
            fixedHeader: {
                header: true,
                footer: true
            },
            ...
            "columns": [
                ...
                {
                    data: 'successful_records_created_at',
                }
            ],
