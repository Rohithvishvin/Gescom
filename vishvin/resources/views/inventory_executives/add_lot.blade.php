                                        ...
                                        <div class="col-12">
                                            <div class="mb-4">
                                                ...
                                                {{-- <select name="division" class="form-control">
                                                    <option value="hubli">Gulberga</option>
                                                    <option value="dharwad">Gulberga ballery</option>
                                            
                                                </select> --}}
                                                <select name="division" class="form-control">
                                                    <option value="870900">Gulberga, 870900</option>
                                                    <option value="870900">Gulberga Ballery, 870900</option>
