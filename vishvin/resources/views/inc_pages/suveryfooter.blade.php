...
<?php if(!empty(session()->get('failed'))) { ?>
 ...
 <?php if(!empty(session()->get('success'))) { ?>
   ...
   <div class="osahan-menu-fotter fixed-bottom bg-dark text-center m-3 shadow rounded py-2">
      <div class="row m-0">
        <a href="/Survey/home" class="text-white col small text-decoration-none p-2 disabled" >
          <p class="h5 m-0"><i class="fa-sharp fa-solid fa-house" style="color:white;"></i></p>Home
        </a>
        <a href="/Survey/add_meter_first_step" class="text-white col small text-decoration-none p-2 disabled">
        ...
        <a href="/Survey/account" class="text-white col small text-decoration-none p-2 disabled">
