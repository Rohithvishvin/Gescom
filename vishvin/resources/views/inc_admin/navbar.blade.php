...
<div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box">
        ...
        <!-- <a href="index.html" class="logo logo-dark">
            ...
            <span class="logo-lg">
                <img src="/assets_admin/images/logo-dark.png" alt="" height="30">
            </span>
        </a> -->
        <!-- Light Logo-->
        <!-- <a href="index.html" class="logo logo-light">
            ...
            <span class="logo-lg">
                <img src="/assets_admin/images/logo-light.png" alt="" height="30">
            </span>
        </a> -->
    ...
    <div id="scrollbar">
        <div class="container-fluid">
            <img src="/assets_admin/images/vishvin/logo.jpg" class="card-logo card-logo-dark" alt="logo dark"
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    @if (Session('rexkod_vishvin_auth_user_type') == 'admin')
                        <a class="nav-link menu-link" href="/project_heads/index">
                    ...
                    @elseif (Session('rexkod_vishvin_auth_user_type') == 'inventory_manager')
                        <a class="nav-link menu-link" href="/inventories/inventory_manager_index">
                            <i class="ri-dashboard-2-line"></i> <span data-key="t-dashboards">Home</span>
                        </a>
                    @elseif (Session('rexkod_vishvin_auth_user_type') == 'inventory_executive')
                        <a class="nav-link menu-link" href="/inventories/inventory_executive_index">
                            <i class="ri-dashboard-2-line"></i> <span data-key="t-dashboards">Home</span>
                        </a>
                    @elseif (Session('rexkod_vishvin_auth_user_type') == 'inventory_reporter')
                        <a class="nav-link menu-link" href="/inventories/inventory_reporter_index">
                            <i class="ri-dashboard-2-line"></i> <span data-key="t-dashboards">Home</span>
                        </a>
                    @elseif (Session('rexkod_vishvin_auth_user_type') == 'qc_manager')
                        <a class="nav-link menu-link" href="/qcs/index">
                            <i class="ri-dashboard-2-line"></i> <span data-key="t-dashboards">Home</span>
                        </a>
                    @elseif (Session('rexkod_vishvin_auth_user_type') == 'hescom_manager')
                        <a class="nav-link menu-link" href="/hescoms/index">
                            <i class="ri-dashboard-2-line"></i> <span data-key="t-dashboards">Home</span>
                        </a>
                    @elseif (Session('rexkod_vishvin_auth_user_type') == 'contractor_manager')
                        <a class="nav-link menu-link" href="/contractors/index">
                            <i class="ri-dashboard-2-line"></i> <span data-key="t-dashboards">Home</span>
                        </a>
                    @elseif (Session('rexkod_vishvin_auth_user_type') == 'aee')
                        <a class="nav-link menu-link" href="/hescoms/aee_index">
                            <i class="ri-dashboard-2-line"></i> <span data-key="t-dashboards">Home</span>
                        </a>
                    @elseif (Session('rexkod_vishvin_auth_user_type') == 'ae')
                        <a class="nav-link menu-link" href="/hescoms/ae_index">
                            <i class="ri-dashboard-2-line"></i> <span data-key="t-dashboards">Home</span>
                        </a>
                    @elseif (Session('rexkod_vishvin_auth_user_type') == 'aao')
                        <a class="nav-link menu-link" href="/hescoms/aao_index">
                            <i class="ri-dashboard-2-line"></i> <span data-key="t-dashboards">Home</span>
                        </a>
                    @elseif (Session('rexkod_vishvin_auth_user_type') == 'bmr')
                        <a class="nav-link menu-link" href="/bmrs/index">
                            <i class="ri-dashboard-2-line"></i> <span data-key="t-dashboards">Home</span>
                        </a>
                    @endif
                ...
                @if (Session('rexkod_vishvin_auth_user_type') == 'project_head')
                    <li class="menu-title"><i class="ri-more-fill"></i> <span data-key="t-components">Project
                            Heads</span></li>
                    <li class="nav-item">
                        <a href="/project-heads/show-users" class="nav-link" role="button">
                            <i class="ri-layout-3-line"></i> <span data-key="t-apps">Show All Users</span>
                        </a>
                    </li>
				    <li class="nav-item">
                        <a href="/project_heads/half_work" class="nav-link" role="button">
                            <i class="ri-layout-3-line"></i> <span data-key="t-apps">Show half work</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="/project_heads/get-account-id-details" class="nav-link" role="button">
                            <i class="ri-apps-2-line"></i> <span data-key="t-apps">Check Account ID</span>
                        </a>
                   <!-- </li>
					      <li class="nav-item">
                        <a href="/qcs/frchange" class="nav-link" role="button">
                            <i class="ri-layout-3-line"></i> <span data-key="t-apps">Final reading (FR) Change</span>
                        </a>
                    </li>--->
				
				  <li class="nav-item">
                       <a class="nav-link menu-link" href="/inventories/faulty_meter_inventories">
                            <i class="ri-dashboard-2-line"></i> <span data-key="t-dashboards">check Faulty Serial Number</span>
                         </a>
                    </li>
				
				   <li class="nav-item">
                       <a class="nav-link menu-link" href="/hescoms/push_to_vishvin_qc">
                            <i class="ri-dashboard-2-line"></i> <span data-key="t-dashboards">Push to Vishvin QC</span>
                         </a>
                    </li>
				
				  <li class="nav-item">
                       <a class="nav-link menu-link" href="/hescoms/serial_number_ownership">
                            <i class="ri-dashboard-2-line"></i> <span data-key="t-dashboards">Meter Serial No. ownership Takeover</span>
                         </a>
                    </li>
				
				
				  <li class="nav-item">
                       <a class="nav-link menu-link" href="/inventories/get_push_unused_state">
                            <i class="ri-dashboard-2-line"></i> <span data-key="t-dashboards">Push Serial Number to Unused state</span>
                         </a>
                    </li>
				
				  <li class="nav-item">
                       <a class="nav-link menu-link" href="/hescoms/consumer_details_update">
                            <i class="ri-dashboard-2-line"></i> <span data-key="t-dashboards">Meter Type Update</span>
                         </a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="/hescoms/meter_mains_edit">
                            <i class="ri-dashboard-2-line"></i>
                            <span data-key="t-dashboards">Meter mains Update</span>
                        </a>
                    </li>

				    <li class="nav-item">
                       <a class="nav-link menu-link" href="/inventories/faulty_meter_report">
                            <i class="ri-dashboard-2-line"></i> <span data-key="t-dashboards">Faulty Meter Report</span>
                         </a>
                    </li>
                    <li class="nav-item">
                    ...
                    {{-- <li class="nav-item">
                        <a class="nav-link menu-link" href="#sidebarApps" data-bs-toggle="collapse" role="button"
                            aria-expanded="false" aria-controls="sidebarApps">
                            <i class="ri-apps-2-line"></i> <span data-key="t-apps">Reports New</span>
                        </a>

                        <ul class="nav nav-sm flex-column">

                            <li class="nav-item">
                                <a href="/project_heads/release_meter_report" class="nav-link" data-key="t-calendar">Release Meter
                                </a>
                            </li>
                        </ul>
                    </li> --}}
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="/project_heads/consumer_bulk_upload">
                            <i class="ri-dashboard-2-line"></i> <span data-key="t-dashboards">Bulk Upload Consumer Detail</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="/project_heads/upload_meter_previous_final_reading">
                            <i class="ri-dashboard-2-line"></i> <span data-key="t-dashboards">Bulk Upload Meter Last Reading</span>
                        </a>
                    </li>
                @endif
                @if (Session('rexkod_vishvin_auth_user_type') == 'project_head' || Session('rexkod_vishvin_auth_user_type') == 'hescom_manager')
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="/project_heads/inventory_report_filter">
                            <i class="ri-dashboard-2-line"></i> <span data-key="t-dashboards">Inventory Reports</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="/project_heads/meter_replacement_statistics">
                            <i class="ri-dashboard-2-line"></i> <span data-key="t-dashboards">Meter Replacement Statistics</span>
                        </a>
                    </li>
                @endif
                @if (Session('rexkod_vishvin_auth_user_type') == 'project_head' || Session('rexkod_vishvin_auth_user_type')=='ae' || Session('rexkod_vishvin_auth_user_type')=='aee' || Session('rexkod_vishvin_auth_user_type')=='aao' || Session('rexkod_vishvin_auth_user_type')=='hescom_manager')
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="/project_heads/report_filter">
                            <i class="ri-dashboard-2-line"></i> <span data-key="t-dashboards">Reports New</span>
                        </a>

                    </li>
                @endif
				
				        @if (Session('rexkod_vishvin_auth_user_type') == 'project_head' || Session('rexkod_vishvin_auth_user_type') == 'qc_executive' || Session('rexkod_vishvin_auth_user_type') == 'qc_manager')
                <li class="nav-item">
                        <a class="nav-link menu-link" href="/qcs/dateReplacement">
                            <i class="ri-dashboard-2-line"></i> <span data-key="t-dashboards">Date Replacement</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="/project_heads/get-account-id-details" class="nav-link" role="button">
                ...
                {{--                @if(Session('rexkod_vishvin_auth_user_type') == 'project_head')--}}
                {{--                    <li class="nav-item">--}}
                {{--                        <a class="nav-link menu-link" href="/project_heads/view_bmr_status">--}}
                {{--                            <i class="ri-dashboard-2-line"></i> <span data-key="t-dashboards">BMR Status</span>--}}
                {{--                        </a>--}}
                {{--                    </li>--}}
                {{--                @endif--}}
        ...
        <i class="ri-dashboard-2-line"></i> <span data-key="t-dashboards">QC Executive View</span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link menu-link"
                           href="/qcs/qc_view?so_code={{$filter_requests['section_code']??''}}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="/qcs/preview_meter_reports">
                            <i class="ri-dashboard-2-line"></i> <span data-key="t-dashboards">Preview QC Records</span>
                        </a>
                    </li>
                    {{--                    <li class="nav-item">--}}
                ...
                @if (Session('rexkod_vishvin_auth_user_type') == 'ae' ||
                    ...
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="/hescoms/hescom_view">
                            <i class="ri-dashboard-2-line"></i>
                            <span data-key="t-dashboards">Records for Approval</span>
                        </a>
                    </li>
                @endif
                @if (Session('rexkod_vishvin_auth_user_type') == 'ae' ||
                ...
                @if (Session('rexkod_vishvin_auth_user_type') == 'aao')
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="/hescoms/error_reports">
                            <i class="ri-dashboard-2-line"></i>
                            <span data-key="t-dashboards">Error Records as per TRM</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="/hescoms/meter_mains_edit">
                ...
                <li class="nav-item">
                        <a class="nav-link menu-link" href="/admins/reset_password">
                            <i class="ri-dashboard-2-line"></i> <span data-key="t-dashboards">Reset Your Password</span>
                        </a>
                    </li>
                <li class="nav-item">
