                                        ...
                                        <div class="table-responsive">
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    @endphp
                                                    @foreach ($data['get_all_so_code_for_hubballi'] as $get_all_so_code)
                                                        @php
                                                            // $indents = Indent::get();
                                        ...
                                        <div class="table-responsive">
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    @endphp
                                                    @foreach ($data['get_all_sd_code_for_hubballi'] as $get_all_sd_code)
                                                        @php
                                ...
                                <div class="col-xl-12 col-md-12 dash-xl-100 dash-lg-100 dash-39">
                                    <div class="card ongoing-project recent-orders">
                                        ...
                                        <div class="row container-fluid">
                                            <div class="col-12">
                                                <form method="GET" action="{{url('/')}}/project_heads/index">
                                                    @csrf
                                                    <div class="row mb-2">
