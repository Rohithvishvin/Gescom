...
<div class="osahan-home-page">
    ...
    <!-- body -->
    <div class="osahan-body" style="padding-bottom:250px;">
        <!-- categories -->
        <div class="text-center position-absolute top-50 start-50 translate-middle">
            ...
            @foreach($data['meter_main'] as $meter)
                ...
                @endphp
            @endforeach
            <p>{{$data['lat']}}{{session()->get('user_lat')}}You have installed <span
                        style="font-size:17px;">{{$count}}</span> Meters </p>
        </div>
    </div>

    <div class="row m-0 table-responsive-sm" style="margin-top:90px;">
        <div class="col ps-0 pe-1 py-1" class="table-responsive-sm" style="padding-top:500px;margin-top:90px;">
...
<script>
    ...
    $.get('/api/pages/home_api', function (data) {
        console.log(data);
    })
