      ...
      <div class="osahan-order_address">
         <div class="p-3 shadow-sm bg-white border-bottom">
            <div class="d-flex align-items-center">
               ...
               <h5 class="fw-bold m-0 ms-3">New Meters</h5>
               ...
               <!-- <a class="btn btn-outline-success btn-sm ms-auto" href="/pages/add">Add</a> -->
            </div>
         </div>
         <div class="p-3">
               ...
               <label class="form-check-label w-100" for="customRadioInline1">
                  <div>
                     <div class="p-3 bg-white rounded shadow-sm w-100">
                        ...
                        <!-- <p class="pt-2 m-0 text-end"><span class="small"><a href="#"  data-bs-toggle="modal" data-bs-target="#exampleModal" class="text-decoration-none text-dark">New Details</a></span></p> -->
                     </div>
                  </div>
               </label>
            </div>
